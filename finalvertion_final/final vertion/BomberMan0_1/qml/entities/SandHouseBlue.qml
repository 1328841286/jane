...
EntityBase {
    id:sandHouseBlue
    entityId: "sandHouseBlue"
    entityType: "po_sandHouseBlue"
    width: 26
    height: 26

    property alias sandHouseBlueBody: sandHouseBlueBody
    property alias circleCollider: boxCollider

    Image {
      id: sandHouseBlueBody
      width:26
      height: 26
      source:"../../assets/img/SandHouseBlue.bmp"
    }
